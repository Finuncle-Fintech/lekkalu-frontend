...
import { CumSumChart, handleMouseOver, handleSyncMethod } from '../components/Charts/CumSumChart'
import { CumSumData } from './data/Data'
...
const { user, container } = setup(<CumSumChart data={CumSumData} />)
