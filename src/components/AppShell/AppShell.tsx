...
export default function AppShell({ children }: Props) {
  ...
  return (
    <div className='h-screen grid grid-cols-12'>
      <Sidebar className='hidden md:block md:col-span-3 min-[1270px]:col-span-2' />
      <div className='relative col-span-12 md:col-span-9 min-[1270px]:col-span-10 overflow-y-auto'>
