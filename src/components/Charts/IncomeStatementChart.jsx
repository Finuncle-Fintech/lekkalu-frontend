            ...
            <div className={styles.mainTooltip}>
              ...
              >
                <span
                  style={{
                    fontWeight: 'bold',
                    color: Colors.PIE[pieData.map((e) => e.name).indexOf(payload[0].name)].end,
                  }}
                >
                  {`${payload[0].name} : `}
                </span>
                ...
                >{`${preferences.currencyUnit} ${numDifferentiation(payload[0].value)} `}</span>
              </label>
                      ...
                      <div style={{ width: '100%' }}>
                        <p style={{ width: '100%', lineHeight: '0.5rem' }}>
                          ...
                          <span style={{ fontWeight: 700 }}>
                            {`${preferences.currencyUnit} ${numDifferentiation(each.value)} `}
                          </span>
                        </p>
                      </div>
                    )
