    ...
    <>
      {!hideFiltering && (
        <div className="mb-4 flex items-center justify-between">
          <div className="flex items-center" style={{ backgroundColor: '#ffffff', borderRadius: '12px', padding: '18px'}}>
              ...
              <tr {...headerGroup.getHeaderGroupProps()}>
                {headerGroup.headers.map(column => (
                  ...
                  {...column.getHeaderProps({
                    ...
                    style: { minWidth: column.minWidth, width: column.width, cursor: 'pointer' }
                  })}>
