...
const Header = () => {
    // const { signOut, authToken, user } = useAuthContext()
    const { tokenData, logout } = useAuthContext()
    const [openCalculator, setOpenCalculator] = React.useState<boolean>(false)
    ...
    const userSetting: UserSetting = {
        submenu: {
            1: {
                name: 'lalith', //  TBD: User should be fetched dynamically
                icon: <Person />,
                path: '/profile',
            },
            2: {
    ...
    const calculatorOption: UserSetting = {
        submenu: {
            1: {
                name: 'SIP',
                icon: null,
    ...
    return (
        <React.Fragment>
            <Box sx={styles.appBar}>
                ...
                {tokenData ? <BasicMenu sx={styles.iconButton} Menu={userSetting} /> : null}
                            ...
                            <Collapse in={openCalculator} timeout='auto' unmountOnExit>
                                <List component='div' disablePadding>
                                    <ListItemButton
                                        ...
                                        sx={{
                                            pl: 4,
                                            backgroundColor: isActive('/SIPCalculator') ? 'white' : '#1976D2',
                                    ...
                                    <ListItemButton
                                        ...
                                        sx={{
                                            pl: 4,
                                            backgroundColor: isActive('/CAGRCalculator') ? 'white' : '#1976D2',
                                    ...
                                    <ListItemButton
                                        ...
                                        sx={{
                                            pl: 4,
                                            backgroundColor: isActive('/loan_emi_calculator') ? 'white' : '#1976D2',
