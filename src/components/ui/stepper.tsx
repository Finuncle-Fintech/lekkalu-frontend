...
const Stepper = React.forwardRef<HTMLDivElement, StepperProps>(function Stepper(props, ref: React.Ref<HTMLDivElement>) {
  const {
    className,
    children,
...
const Step = React.forwardRef<HTMLLIElement, StepProps>(function StepComponent(props, ref: React.Ref<any>) {
  const {
    children,
    description,
    icon,
...
const VerticalStep = React.forwardRef<HTMLDivElement, VerticalStepProps>(function VerticalStep(props, ref) {
  const {
    children,
    index,
    isCompletedStep,
...
const HorizontalStep = React.forwardRef<HTMLDivElement, StepSharedProps>(function HorizontalStep(props, ref) {
  const {
    isError,
    isLoading,
    onClickStep,
...
const StepIcon = React.forwardRef<HTMLDivElement, StepIconProps>(function StepIcon(props, ref) {
  ...
  const Check = React.useMemo(() => CustomCheckIcon || CheckIcon, [CustomCheckIcon])
