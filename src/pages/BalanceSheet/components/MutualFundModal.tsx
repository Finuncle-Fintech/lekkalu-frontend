...
const MutualFundModal: React.FC<AssetModalProps> = ({ isDialogOpen, setIsDialogOpen, asset }: AssetModalProps) => {
  ...
  return (
    <AssetModal
      ...
      description='Add any Mutual Funds that you own. And specify expected returns to gauge your
