...
const EmiCalculator = () => {
  ...
  useEffect(() => {
    setAssets(calculateLoanPrincipalAndInterestPayable(data?.loan_principal, results?.total_interest_payable))
  }, [data, results])
    ...
    <div className='container'>
      ...
      <div className='output'>
        <div className='output-text'>
          ...
          <DisplayResult value={results?.total_interest_payable} label='Total Interest Payable' />
          <DisplayResult value={results?.total_payment} label='Total Payment' />
        </div>
        <div className='output-chart'>
          {assets && data.loan_principal && data.loan_interest && data.loan_tenure && (
