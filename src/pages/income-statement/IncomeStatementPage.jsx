...
const IncomeStatementPage = () => {
  ...
  const salaryValues = incomeStatement.income.filter(
    (item) => item.type === "Salary"
  );
  const sumOfSalaryValues = salaryValues.reduce(
    (total, item) => total + item.value,
    0
  );

  // Step 2: Calculate the percentage of "Salary" data compared to the total value
  const totalValue = incomeStatement.income.reduce(
    (total, item) => total + item.value,
    0
  );
                ...
                >
                  ...
                  >
                    ...
                    <div>
                      ...
                      >
                        {!Number.isNaN(personalPercentage)
                ...
                >
                  ...
                  >
                    ...
                    <div>
                      ...
                      >
                        {!Number.isNaN(loanRepaymentPercentage)
                ...
                >
                  ...
                  >
                    ...
                    <div>
                      ...
                      >
                        {!Number.isNaN(investmentPercentage)
